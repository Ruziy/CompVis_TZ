...
model_yolov5 = YOLOv5(r"C:\Users\Alex\Desktop\CompVis\source\best_yolov5.pt", device=device)
model_yolov8 = YOLO(r"C:\Users\Alex\Desktop\CompVis\source\best_yolov8.pt").to(device)
...
async def main():
    ...
    <html>
        ...
        <body>
            ...
            <p>{device_status}</p> <!-- Displaying device status here -->
...
async def detect(file: UploadFile = File(...), model: str = Form(...)):
    try:
        ...
        if model == "yolov5":
            ...
            results = model_yolov8.predict(image, imgsz=640, conf=0.25, save=False)
